...
> 曾编号为「M6」，与 [005-product-3.0.md](../plans/iOS/005-product-3.0.md) 里的 M6「分发与增长」撞名，
...
[003-tauri-desktop.md §6](../plans/iOS/003-tauri-desktop.md) 已经决定不购买代码签名证书。这一条把
...
NSIS 安装向导的 14 种语言（[004-shift-model-3.1.0.md §1.1](../plans/iOS/004-shift-model-3.1.0.md)）在 MSIX 里不适用
