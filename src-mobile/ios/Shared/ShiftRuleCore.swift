...
/// One salary-free scheduling implementation, compiled by iOS and watchOS.
nonisolated enum ShiftRuleCore {
    ...
    static func resolveCurrentShift(_ input: ScheduleRuleInput, _ zone: CivilZone) -> ShiftTimeline {
    ...
    static func nextShift(after shift: ShiftTimeline, _ input: ScheduleRuleInput, _ zone: CivilZone) -> ShiftTimeline? {
    ...
    static func isActualShift(_ shift: ShiftTimeline, _ input: ScheduleRuleInput, _ zone: CivilZone) -> Bool {
...
nonisolated struct ShiftOptions: Sendable {
    ...
    init(_ input: ScheduleRuleInput) {
