...
- iOS runs every shared rule in Swift since plan 019 R1–R3, in
  ...
  live roster, and lays hand-set days over fixed hours from before the
  extended schedule began — decoding it directly silently falls back to the
  fixed hours and loses both. iOS has no JavaScriptCore rules bundle since plan 019 R4; do
