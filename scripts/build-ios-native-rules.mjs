...
// to Swift yet (plan 019 R3): summaries and income. Shift resolution,
// snapshots, expansion and reminders are Swift since R1 and R2.`,
    moduleNames: ["./countdown", "./summary"],
    body: `
