...
通过、失败、待真机项分别记录于 [本轮验收记录](../docs/reviews/2026-09-19-watch-calendar-acceptance.md)。不据此勾选整个 018 或发布门禁。下一目标为 018 已规划的节假日与调休模板：内置数据、系统地区默认、可切换关闭、人工改班优先、未知年份不猜测；本轮未接入该数据。
