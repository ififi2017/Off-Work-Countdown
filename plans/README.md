...
| 019 | [iOS 规则与本地化回到 iOS 工程](019-ios-native-rules-and-localization.md) | 2026-09-13 | TODO | 用户决定 iOS 规则回到 Swift、iOS 文案迁入 iOS 工程；按入口分批迁移并以 TS 差分 fixture 为契约，首批同版修改 AGENTS.md；018 P8 扩展排班依赖 R1 |
