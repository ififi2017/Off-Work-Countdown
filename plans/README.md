...
| 019 | [iOS 规则与本地化回到 iOS 工程](019-ios-native-rules-and-localization.md) | 2026-09-13 | IN PROGRESS | R1 已实现：班次解析、快照、Widget 班次、Watch 投影与区间展开迁到 `ScheduleRules.swift`，以 TS 差分 fixture 为契约并同版修改 AGENTS.md；R2–R4 与本地化迁移未开工。018 P8 的前置条件已满足 |
